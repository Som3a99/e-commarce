...
app = Flask(__name__)
app.config['SECRET_KEY'] = '5aa1459744f3e89db0816788af5ef49e1b1db0f62c4b801b92a3b618504af071'
...
app.config['MAIL_USERNAME'] = 'engmohamedismail56@gmail.com'
app.config['MAIL_PASSWORD'] = 'tfui lliv cgqx rjzr'
